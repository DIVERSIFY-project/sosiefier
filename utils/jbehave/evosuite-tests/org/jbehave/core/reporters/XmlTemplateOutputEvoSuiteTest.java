...
public class XmlTemplateOutputEvoSuiteTest {
  ...
  public void test0()  throws Throwable  {
      ...
      try {
         ...
         */
        /*
      %%%<ex><className val="NullPointerException"/><stackDepth val="15"/><causeDepth val="0"/><source val="java.io.File.&lt;init&gt;(File.java:239)"/></ex>%%%
         */
      }
  }
  ...
  public void test3()  throws Throwable  {
      String string0 = "r@JFE(j";
      File file0 = new File("r@JFE(j");
  ...
  /*
   * 1 covered goal:
   * 1 org.jbehave.core.reporters.XmlTemplateOutput.<init>(Ljava/io/File;Lorg/jbehave/core/configuration/Keywords;Lorg/jbehave/core/reporters/TemplateProcessor;Ljava/lang/String;)V: root-Branch
   */
  @Test
  public void test4()  throws Throwable  {
      Class<?> class0 = XmlTemplateOutput.class;
      FreemarkerProcessor freemarkerProcessor0 = new FreemarkerProcessor(class0);
      String string0 = "";
      XmlTemplateOuput xmlTemplateOuput0 = new XmlTemplateOuput((File) null, (Keywords) null, (TemplateProcessor) freemarkerProcessor0, "");
      Description description0 = Description.EMPTY;
      Meta meta0 = new Meta();
      Narrative narrative0 = Narrative.EMPTY;
      GivenStories givenStories0 = null;
      try {
        givenStories0 = new GivenStories("");
  ...
  public void test5()  throws Throwable  {
      String string0 = "YES\\9";
      // Undeclared exception!
      try {
        File.createTempFile(string0, string0);
      }catch(SecurityException e) {
        /*
         * Security manager blocks (java.io.FilePermission /tmp/YES\\91187372032950856797YES\\9 write)
  ...
  public void test6()  throws Throwable  {
      String string0 = "<div class=\"property\">{0}{1} {2}</div>\n";
      File file0 = new File("<div class=\"property\">{0}{1} {2}</div>\n", "<div class=\"property\">{0}{1} {2}</div>\n");
