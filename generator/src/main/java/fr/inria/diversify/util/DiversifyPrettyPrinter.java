...
// */
//public class DiversifyPrettyPrinter implements CtVisitor, PrettyPrinter  {
//    /**
...
//     */
//    public DiversifyPrettyPrinter(Environment env) {
//        super();
//        this.env = env;
//    }
//
...
//     */
//    public DiversifyPrettyPrinter decTab() {
//        context.nbTabs--;
//        return this;
//    }
//
...
//                write("(");
//                DiversifyPrettyPrinter.this.scan(r);
//                write(")");
//                write("(");
//                context.parenthesedExpression.push(e);
//            }
...
//     */
//    public DiversifyPrettyPrinter incTab() {
//        context.nbTabs++;
//        return this;
//    }
//
...
//     */
//    public DiversifyPrettyPrinter setTabCount(int tabCount) {
...
//     */
//    protected DiversifyPrettyPrinter removeLastChar() {
...
//     */
//    public DiversifyPrettyPrinter scan(CtElement e) {
//        if (e != null) {
...
//     */
//    public DiversifyPrettyPrinter scan(CtReference ref) {
//        if (ref != null) {
//            ref.accept(this);
//        }
//        return this;
...
//            write("(");
//            for (Map.Entry<String, Object> e : annotation.getElementValues()
//                                                         .entrySet()) {
//                write(e.getKey() + " = ");
...
//    }
//
//    public DiversifyPrettyPrinter writeExtendsClause(CtClass<?> c) {
...
//    }
//
//    public DiversifyPrettyPrinter writeImplementsClause(CtType<?> t) {
...
//    }
//
//    public <T> DiversifyPrettyPrinter writeLocalVariable(
...
//    }
//
//    public DiversifyPrettyPrinter writeTypeReference(CtTypeReference<?> t) {
//        scan(t);
//        return this;
//    }
//
//    public DiversifyPrettyPrinter writeExecutableParameters(CtExecutable<?> e) {
...
//    }
//
//    public DiversifyPrettyPrinter writeThrowsClause(CtExecutable<?> e) {
...
//    }
//
//    public DiversifyPrettyPrinter writeModifiers(CtModifiable m) {
...
//     * Outputs a string.
//     */
//    public DiversifyPrettyPrinter write(String s) {
//        if (s != null) {
//            sbf.append(s);
//        }
//        return this;
...
//     * Outputs a char.
//     */
//    public DiversifyPrettyPrinter write(char c) {
//        sbf.append(c);
//        return this;
//    }
//
...
//     */
//    public DiversifyPrettyPrinter writeAnnotations(CtElement e) {
...
//     */
//    public DiversifyPrettyPrinter writeAnnotationElement(Factory factory,
//                                                           Object value) {
...
//     */
//    public DiversifyPrettyPrinter writeGenericsParameter(
...
//     */
//    public DiversifyPrettyPrinter writeHeader(List<CtSimpleType<?>> types,
...
//     */
//    public DiversifyPrettyPrinter writeln() {
...
//    }
//
//    public DiversifyPrettyPrinter writeTabs() {
//        // context.currentLength = 0;
...
//     */
//    public DiversifyPrettyPrinter writeOperator(BinaryOperatorKind o) {
//        switch (o) {
//            case OR:
//                write("||");
//                break;
