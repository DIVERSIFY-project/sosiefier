 ...
 */
public class SubClassReplaceTransformation extends ASTReplace {

    public SubClassReplaceTransformation(CodeFragment transplantationPoint, CodeFragment copyTransplant) {
        this.transplantationPoint = transplantationPoint;
        this.transplant = copyTransplant;
        name = "subClassReplace";
        type = "replace";
    }
