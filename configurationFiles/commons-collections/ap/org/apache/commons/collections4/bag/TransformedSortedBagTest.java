...
public class TransformedSortedBagTest<T> extends AbstractSortedBagTest<T> {
    ...
    public void testTransformedBag() {
        ...
        fr.inria.diversify.testamplification.logger.Logger.logAssertArgument(Thread.currentThread(),5890,bag,5889,bag.remove(java.lang.Integer.valueOf(((java.lang.String)(els[0])))));
    ...
    public void testTransformedBag_decorateTransform() {
        ...
        fr.inria.diversify.testamplification.logger.Logger.logAssertArgument(Thread.currentThread(),5891,els.length);
        fr.inria.diversify.testamplification.logger.Logger.logAssertArgument(Thread.currentThread(),5893,bag,5892,bag.size());
        for (final Object el : els) {
            fr.inria.diversify.testamplification.logger.Logger.logAssertArgument(Thread.currentThread(),5895,bag,5894,bag.contains(java.lang.Integer.valueOf(((java.lang.String)(el)))));
        }
        fr.inria.diversify.testamplification.logger.Logger.logAssertArgument(Thread.currentThread(),5897,bag,5896,bag.remove(java.lang.Integer.valueOf(((java.lang.String)(els[0])))));
        fr.inria.diversify.testamplification.logger.Logger.writeTestFinish(Thread.currentThread());
    }
