...
@Override
    public void verify() {
        ...
        while (colliter.hasNext()) {
            ...
            fr.inria.diversify.testamplification.logger.Logger.logAssertArgument(Thread.currentThread(),5818,last);
            fr.inria.diversify.testamplification.logger.Logger.logAssertArgument(Thread.currentThread(),5820,confiter,5819,confiter.next());
        }
        if ((getCollection().size()) > 0) {
            fr.inria.diversify.testamplification.logger.Logger.logAssertArgument(Thread.currentThread(),5821,first);
            fr.inria.diversify.testamplification.logger.Logger.logAssertArgument(Thread.currentThread(),5823,getCollection(),5822,getCollection().first());
            fr.inria.diversify.testamplification.logger.Logger.logAssertArgument(Thread.currentThread(),5824,last);
            fr.inria.diversify.testamplification.logger.Logger.logAssertArgument(Thread.currentThread(),5826,getCollection(),5825,getCollection().last());
        } 
    }
