...
String calculateRawEncoding(String bomEnc, String xmlGuessEnc, String xmlEnc) throws IOException {
        ...
        if (bomEnc.equals(UTF_8)) {
            if ((xmlGuessEnc != null) && (!(xmlGuessEnc.equals(UTF_8)))) {
                String msg = java.text.MessageFormat.format(RAW_EX_1, new java.lang.Object[]{ bomEnc , xmlGuessEnc , xmlEnc });
        ...
        String msg = java.text.MessageFormat.format(RAW_EX_2, new java.lang.Object[]{ bomEnc , xmlGuessEnc , xmlEnc });
        throw new XmlStreamReaderException(msg , bomEnc , xmlGuessEnc , xmlEnc);
    }
...
String calculateHttpEncoding(String httpContentType, String bomEnc, String xmlGuessEnc, String xmlEnc, boolean lenient) throws IOException {
        ...
        if ((!appXml) && (!textXml)) {
            String msg = java.text.MessageFormat.format(HTTP_EX_3, cTMime, cTEnc, bomEnc, xmlGuessEnc, xmlEnc);
        ...
        if ((cTEnc.equals(UTF_16BE)) || (cTEnc.equals(UTF_16LE))) {
            if (bomEnc != null) {
                String msg = java.text.MessageFormat.format(HTTP_EX_1, cTMime, cTEnc, bomEnc, xmlGuessEnc, xmlEnc);
                throw new XmlStreamReaderException(msg , cTMime , cTEnc , bomEnc , xmlGuessEnc , xmlEnc);
            } 
            return cTEnc;
        } 
        if (cTEnc.equals(UTF_16)) {
            ...
            String msg = java.text.MessageFormat.format(HTTP_EX_2, cTMime, cTEnc, bomEnc, xmlGuessEnc, xmlEnc);
            throw new XmlStreamReaderException(msg , cTMime , cTEnc , bomEnc , xmlGuessEnc , xmlEnc);
        } 
