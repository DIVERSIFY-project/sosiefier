...
public class Base64Codec13Test {
    ...
    static {
        Base64Codec13Test.initSTRINGS();
        Base64Codec13Test.initCHUNKED_STRINGS();
        Base64Codec13Test.initBYTES();
    }
...
@Test
    public void testEncoder() throws EncoderException {
        fr.inria.diversify.testamplification.logger.Logger.writeTestStart(Thread.currentThread(),this, "testEncoder");
...
@Test
    public void testDecoder() throws DecoderException {
        fr.inria.diversify.testamplification.logger.Logger.writeTestStart(Thread.currentThread(),this, "testDecoder");
...
@Test
    ...
    private static byte[] utf8(final String s) {
        return s != null ? s.getBytes(org.apache.commons.codec.Charsets.UTF_8) : null;
    }
}
