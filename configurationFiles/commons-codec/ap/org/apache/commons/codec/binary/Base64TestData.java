...
static byte[][] randomData(final int size, final boolean urlSafe) {
        ...
        r.nextBytes(decoded);
        final byte[] encoded = urlSafe ? org.apache.commons.codec.binary.Base64.encodeBase64URLSafe(decoded) : org.apache.commons.codec.binary.Base64.encodeBase64(decoded);
