...
public class TestTypes {
    ...
    public static class ClassWithSerializedNameFields {
        @SerializedName(value = "fooBar")
        public final int f;

        @SerializedName(value = "Another Foo")
        public final int g;
    ...
    public static class CrazyLongTypeAdapter implements JsonDeserializer<java.lang.Long> , JsonSerializer<java.lang.Long> {
